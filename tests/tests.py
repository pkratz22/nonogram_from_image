...
class test_nonogram_from_image(unittest.TestCase):
    ...
    def test_get_image(self):
        self.assertIsNotNone(nonogram_from_image.get_image("tests/input_images/image1.jpg"))
        self.assertIsNotNone(nonogram_from_image.get_image("tests/input_images/image2.jpg"))
