...
class TestNonogramFullArrayFromImage(unittest.TestCase):
    ...
    def test_get_array_from_grid(self):
        ...
        nonogram_image = nonogram_full_array_from_image.get_image(
            nonogram_image_path)
        transformed_image = nonogram_full_array_from_image.transform_image(
            nonogram_image)
        number_of_rows, number_of_cols = nonogram_full_array_from_image.get_num_rows_cols_from_image(
            transformed_image)
        finished_array = nonogram_full_array_from_image.get_array_from_grid(
    ...
    def test_organize_array_by_rows(self):
        ...
        array = [
            ...
            ""]
        self.assertEqual(
            formatted_array_from_full_array.organize_array_by_rows(
    ...
    def test_get_teal_string(self):
        ...
        array = [
            ...
            "",
            ""]
        grid_array = formatted_array_from_full_array.organize_array_by_rows(
            array, number_of_cols)
